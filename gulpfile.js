...
gulp.task('minify-css', function(){
  ...
  gulp.src('./css/black.css') // set this to the file(s) you want to minify. 
    ...
    .pipe(gulp.dest('./css/'));
    gulp.src('./css/blue.css') // set this to the file(s) you want to minify. 
    .pipe(minifyCSS())
    .pipe(size({gzip: false, showFiles: true, title:'minified css'}))
    .pipe(size({gzip: true, showFiles: true, title:'minified css'}))
    .pipe(rename('blue.min.css'))
    .pipe(gulp.dest('./css/'));
  gulp.src('./css/green.css') // set this to the file(s) you want to minify. 
    .pipe(minifyCSS())
    .pipe(size({gzip: false, showFiles: true, title:'minified css'}))
    .pipe(size({gzip: true, showFiles: true, title:'minified css'}))
    .pipe(rename('green.min.css'))
    .pipe(gulp.dest('./css/'));
  gulp.src('./css/lime.css') // set this to the file(s) you want to minify. 
    .pipe(minifyCSS())
    .pipe(size({gzip: false, showFiles: true, title:'minified css'}))
    .pipe(size({gzip: true, showFiles: true, title:'minified css'}))
  ...
  gulp.src('./css/orange.css') // set this to the file(s) you want to minify. 
    ...
    .pipe(gulp.dest('./css/'));
  gulp.src('./css/pink.css') // set this to the file(s) you want to minify. 
    .pipe(minifyCSS())
    .pipe(size({gzip: false, showFiles: true, title:'minified css'}))
    .pipe(size({gzip: true, showFiles: true, title:'minified css'}))
    .pipe(rename('pink.min.css'))
    .pipe(gulp.dest('./css/'));
  gulp.src('./css/purple.css') // set this to the file(s) you want to minify. 
    .pipe(minifyCSS())
    .pipe(size({gzip: false, showFiles: true, title:'minified css'}))
    .pipe(size({gzip: true, showFiles: true, title:'minified css'}))
    .pipe(rename('purple.min.css'))
    .pipe(gulp.dest('./css/'));
  gulp.src('./css/red.css') // set this to the file(s) you want to minify. 
    .pipe(minifyCSS())
    .pipe(size({gzip: false, showFiles: true, title:'minified css'}))
    .pipe(size({gzip: true, showFiles: true, title:'minified css'}))
    .pipe(rename('red.min.css'))
    .pipe(gulp.dest('./css/'));
  gulp.src('./css/sun.css') // set this to the file(s) you want to minify. 
    .pipe(minifyCSS())
    .pipe(size({gzip: false, showFiles: true, title:'minified css'}))
    .pipe(size({gzip: true, showFiles: true, title:'minified css'}))
    .pipe(rename('sun.min.css'))
    .pipe(gulp.dest('./css/'));
...
gulp.task('default', ['pre-process', 'minify-css'], function(){
  ...
  gulp.watch('css/a.css', ['minify-css']);
});
...
gulp.task('default', ['pre-process', 'minify-css', 'bs-reload', 'browser-sync'], function(){
  ...
  gulp.watch('css/a.css', ['bs-reload', 'minify-css']);
